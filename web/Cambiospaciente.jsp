<%-- 
    Document   : Cambiospaciente
    Created on : 13/05/2015, 01:22:03 PM
    Author     : ulises
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="starter-template">
                ...
                <p class="lead">
                    Llene el n&uacute;mero de seguro:
                </p>

                <div class="form-group">            
                    <div class="form-group">
                        <form method="GET" action="${pageContext.request.contextPath}/CambiosPaciente">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <form method="POST" action="${pageContext.request.contextPath}/CambiosPaciente">
